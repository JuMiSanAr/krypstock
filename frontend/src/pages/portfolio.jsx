    ...
    return (
        <>
            ...
            <AllComponentsWrapper>
                ...
                {
                    portfolioInfo.calculations ? <Overview calculations={portfolioInfo.calculations} transactions={portfolioInfo.transactions} portfolioname={portfolioInfo.name} portfolioID={portfolioInfo.id}/> : ''
                }
